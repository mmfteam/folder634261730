...
wget -q -O /root/changelog.txt "https://raw.githubusercontent.com/mmfteam/folder634261730/master/sshxray-main/FILE/PLUGINS/changelog.txt" && chmod +x /root/changelog.txt
