...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/mmfteam/folder634261730/master/sshxray-main/FILE/OPENVPN/ohp"
...
Documentation=https://t.me/MMFTeam_official
