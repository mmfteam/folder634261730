...
```
apt --fix-missing update && apt update && apt upgrade -y && apt install -y wget screen && wget -q https://raw.githubusercontent.com/mmfteam/folder634261730/master/sshxray-main/setup.sh && chmod +x setup.sh && screen -S setup ./setup.sh
```

### Register IP Pm
Telegram : 
### https://t.me/MMFTeam_official
